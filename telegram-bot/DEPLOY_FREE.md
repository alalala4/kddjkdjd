...
6. Если не определил - создайте файл `Procfile`:
   ```
...
Бесплатный сервер - это только хостинг. **API-ключи всё равно платные:**

- **OpenAI** - минимальный депозит $5, хватит на ~месяц активного использования
- **Google Gemini** - бесплатно до 50 запросов/день через AI Studio (для личного использования хватает!)

Итого: если пользуетесь в основном Gemini + иногда GPT - **можно уложиться в $5/месяц** на всё.
